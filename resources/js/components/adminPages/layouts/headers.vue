        ...
        <div class="container-fluid topbar-menu">
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="logo-topbar">
                    <!-- Logo light -->
                    <RouterLink to="/admins" class="logo-light">
                        <span class="logo-lg">
                            <img src="/admin/assets/images/logos/logoA.png" alt="logo" />
                        </span>
                        <span class="logo-sm">
                            <img src="/admin/assets/images/logos/logoA.png" alt="small logo" />
                        </span>
                    </RouterLink>

                    <!-- Logo Dark -->
                    <RouterLink to="/admins" class="logo-dark">
                        <span class="logo-lg">
                            <img src="/admin/assets/images/logos/logoA.png" alt="dark logo" />
                        </span>
                        <span class="logo-sm">
                            <img src="/admin/assets/images/logos/logoA.png" alt="small logo" />
                        </span>
                ...
                <div id="user-dropdown-detailed" class="topbar-item nav-user">
                    <div class="dropdown">
                        <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown" href="#!" aria-haspopup="false" aria-expanded="false">
                            <img src="/admin/assets/images/users/user.jpg" width="32" class="rounded-circle me-lg-2 d-flex" alt="user-image" />
                            <div class="d-lg-flex align-items-center gap-1 d-none">
                                <span>
                                    <h5 class="my-0 lh-1 pro-username">{{ currentUser.fullname }}</h5>
                                    <span class="fs-xs lh-1">{{ currentUser.role }}</span>
                                </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <!-- Logout -->
                            <a href="javascript:void(0);" class="dropdown-item fw-semibold" @click="LogoutFunction">
