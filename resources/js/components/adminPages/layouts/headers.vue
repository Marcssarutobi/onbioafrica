            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="logo-topbar">
                    ...
                    <a href="index.html" class="logo-dark">
                        <span class="logo-lg">
                            <img src="/admin/assets/images/logo-black.png" alt="dark logo" />
                        </span>
                        <span class="logo-sm">
                            <img src="/admin/assets/images/logo-sm.png" alt="small logo" />
                        </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-xxl p-0">
                            <div class="h-100" style="max-height: 380px" data-simplebar="">
                                <div class="row g-0">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="h-100 position-relative rounded-end rounded-0 overflow-hidden" style="background: url(/admin/assets/images/stock/small-8.jpg); background-size: cover">
                            ...
                            <div class="row align-items-center g-1">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item border border-dashed rounded text-center py-2">
                                        <span class="avatar-sm d-block mx-auto mb-1">
                                            <span class="avatar-title text-bg-light rounded-circle">
                                                <img src="/admin/assets/images/logos/google.svg" alt="Google Logo" height="18" />
                                            </span>
                                        </span>
                                ...
                                <div class="col-4">
                                    <a href="javascript:void(0);" class="dropdown-item border border-dashed rounded text-center py-2">
                                        <span class="avatar-sm d-block mx-auto mb-1">
                                            <span class="avatar-title text-bg-light rounded-circle">
                                                <img src="/admin/assets/images/logos/figma.svg" alt="Figma Logo" height="18" />
                                            </span>
                                        </span>
                                ...
                                <div class="col-4">
                                    <a href="javascript:void(0);" class="dropdown-item border border-dashed rounded text-center py-2">
                                        <span class="avatar-sm d-block mx-auto mb-1">
                                            <span class="avatar-title text-bg-light rounded-circle">
                                                <img src="/admin/assets/images/logos/slack.svg" alt="Slack Logo" height="18" />
                                            </span>
                                        </span>
                                ...
                                <div class="col-4">
                                    <a href="javascript:void(0);" class="dropdown-item border border-dashed rounded text-center py-2">
                                        <span class="avatar-sm d-block mx-auto mb-1">
                                            <span class="avatar-title text-bg-light rounded-circle">
                                                <img src="/admin/assets/images/logos/dropbox.svg" alt="Dropbox Logo" height="18" />
                                            </span>
                                        </span>
                        ...
                        <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg">
                            ...
                            <div style="max-height: 300px" data-simplebar="">
                                ...
                                <div class="dropdown-item notification-item py-2 text-wrap" id="message-1">
                                    <span class="d-flex align-items-center gap-3">
                                        <span class="flex-shrink-0 position-relative">
                                            <img src="/admin/assets/images/users/user-4.jpg" class="avatar-md rounded-circle" alt="User Avatar" />
                                ...
                                <div class="dropdown-item notification-item py-2 text-wrap" id="message-2">
                                    <span class="d-flex align-items-center gap-3">
                                        <span class="flex-shrink-0 position-relative">
                                            <img src="/admin/assets/images/users/user-5.jpg" class="avatar-md rounded-circle" alt="User Avatar" />
                                        ...
                                        <span class="flex-grow-1 text-muted">
                                            ...
                                            uploaded files to
                                            <span class="fw-medium text-body">Marketing /admin/assets</span>
                                            <br />
                                ...
                                <div class="dropdown-item notification-item py-2 text-wrap" id="message-3">
                                    <span class="d-flex align-items-center gap-3">
                                        <span class="flex-shrink-0 position-relative">
                                            <img src="/admin/assets/images/users/user-6.jpg" class="avatar-md rounded-circle" alt="User Avatar" />
                                ...
                                <div class="dropdown-item notification-item py-2 text-wrap" id="message-4">
                                    <span class="d-flex align-items-center gap-3">
                                        <span class="flex-shrink-0 position-relative">
                                            <img src="/admin/assets/images/users/user-7.jpg" class="avatar-md rounded-circle" alt="User Avatar" />
                                ...
                                <div class="dropdown-item notification-item py-2 text-wrap" id="message-5">
                                    <span class="d-flex align-items-center gap-3">
                                        <span class="flex-shrink-0 position-relative">
                                            <img src="/admin/assets/images/users/user-8.jpg" class="avatar-md rounded-circle" alt="User Avatar" />
                ...
                <div id="language-selector-rounded" class="topbar-item">
                    <div class="dropdown">
                        <button class="topbar-link fw-bold" data-bs-toggle="dropdown" type="button" aria-haspopup="false" aria-expanded="false">
                            <img src="/admin/assets/images/flags/us.svg" alt="user-image" class="rounded-circle me-2" height="18" id="selected-language-image" />
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="en" title="English">
                                <img src="/admin/assets/images/flags/us.svg" alt="English" class="me-1 rounded-circle" height="18" data-translator-image="" />
                                <span class="align-middle">English</span>
                            </a>
                            <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="de" title="German">
                                <img src="/admin/assets/images/flags/de.svg" alt="German" class="me-1 rounded-circle" height="18" data-translator-image="" />
                                <span class="align-middle">Deutsch</span>
                            </a>
                            <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="it" title="Italian">
                                <img src="/admin/assets/images/flags/it.svg" alt="Italian" class="me-1 rounded-circle" height="18" data-translator-image="" />
                                <span class="align-middle">Italiano</span>
                            </a>
                            <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="es" title="Spanish">
                                <img src="/admin/assets/images/flags/es.svg" alt="Spanish" class="me-1 rounded-circle" height="18" data-translator-image="" />
                                <span class="align-middle">Español</span>
                            </a>
                            <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="ru" title="Russian">
                                <img src="/admin/assets/images/flags/ru.svg" alt="Russian" class="me-1 rounded-circle" height="18" data-translator-image="" />
                                <span class="align-middle">Русский</span>
                            </a>
                            <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="hi" title="Hindi">
                                <img src="/admin/assets/images/flags/in.svg" alt="Hindi" class="me-1 rounded-circle" height="18" data-translator-image="" />
                                <span class="align-middle">हिन्दी</span>
                            </a>
                            <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="ar" title="Arabic">
                                <img src="/admin/assets/images/flags/sa.svg" alt="Arabic" class="me-1 rounded-circle" height="18" data-translator-image="" />
                ...
                <div id="user-dropdown-detailed" class="topbar-item nav-user">
                    <div class="dropdown">
                        <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown" href="#!" aria-haspopup="false" aria-expanded="false">
                            <img src="/admin/assets/images/users/user-1.jpg" width="32" class="rounded-circle me-lg-2 d-flex" alt="user-image" />
