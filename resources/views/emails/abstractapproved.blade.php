               ...
               <td valign="top" align="left">
                <div class="pc-font-alt" style="text-decoration: none;">
                 <div style="font-size:14px;line-height:17px;text-align:left;text-align-last:left;color:#5aa236;font-family:'Fira Sans', Arial, Helvetica, sans-serif;font-style:normal;letter-spacing:-0.2px;">
                  <div style="font-family:'Fira Sans', Arial, Helvetica, sans-serif;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 600; font-size: 14px; line-height: 17px;">Abstract submission – Decision</span>
                  </div>
                 </div>
                </div>
               </td>
               ...
               <td valign="top" align="left">
                <div class="pc-font-alt" style="text-decoration: none;">
                 <div style="font-size:24px;line-height:34px;text-align:left;text-align-last:left;color:#151515;font-family:'Fira Sans', Arial, Helvetica, sans-serif;letter-spacing:-0.4px;font-style:normal;">
                  <div style="font-family:'Fira Sans', Arial, Helvetica, sans-serif;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 24px; line-height: 34px; font-weight: 700;">Dear {{ $abstract->nom }} </span><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 24px; line-height: 34px; font-weight: 700;"> {{ $abstract->prenom }}</span><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 24px; line-height: 34px; font-weight: 700;"> ,</span>
                  </div>
                 </div>
                </div>
               </td>
               ...
               <td valign="top" align="left">
                <div class="pc-font-alt" style="text-decoration: none;">
                 <div style="font-size:18px;line-height:28px;text-align:left;text-align-last:left;color:#4b4b4b;font-family:'Fira Sans', Arial, Helvetica, sans-serif;font-style:normal;letter-spacing:-0.2px;">
                  <div style="font-family:'Fira Sans', Arial, Helvetica, sans-serif;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 400; font-size: 18px; line-height: 28px;">We are pleased to inform you that your abstract entitled</span>
                  </div>
                  <div style="font-family:'Fira Sans', Arial, Helvetica, sans-serif;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 700; font-size: 18px; line-height: 28px;">“{{ $abstract->title_resume }}” has been <strong>accepted</strong> by the committee.</span><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 400; font-size: 18px; line-height: 28px;">.</span>
                  </div>
                 </div>
                </div>
               </td>
             ...
             <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
              <tr>
               <td valign="top" align="left">
                <div class="pc-font-alt" style="text-decoration: none;">
                 <div style="font-size:18px;line-height:28px;text-align:left;text-align-last:left;color:#4b4b4b;font-family:'Fira Sans', Arial, Helvetica, sans-serif;font-style:normal;letter-spacing:-0.2px;">
                  <div style="font-family:'Fira Sans', Arial, Helvetica, sans-serif;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 400; font-size: 18px; line-height: 28px;"> Congratulations on this achievement! </span>
                  </div>
                  <div>
                   <br>
                  </div>
                  <div style="font-family:'Fira Sans', Arial, Helvetica, sans-serif;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 400; font-size: 18px; line-height: 28px;"> <strong>To complete your submission, please proceed with the payment by clicking the link below: </strong> <a href="{{ url('/') }}?id={{ $abstract->id }}&action=paiement" target="_blank">Proceed to payment</a> <br> <br> Further information regarding presentation details and next steps will be communicated to you shortly.</span>
                  </div>
                 </div>
                </div>
               </td>
