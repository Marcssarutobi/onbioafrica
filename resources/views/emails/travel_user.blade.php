               ...
               <td valign="top" align="left">
                <div class="pc-font-alt" style="text-decoration: none;">
                 <div style="font-size:18px;line-height:28px;text-align:left;text-align-last:left;color:#4b4b4b;font-family:'Fira Sans', Arial, Helvetica, sans-serif;font-style:normal;letter-spacing:-0.2px;">
                  <div style="font-family:'Fira Sans', Arial, Helvetica, sans-serif;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 400; font-size: 18px; line-height: 28px;">Thank you for submitting your application for the </span><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 700; font-size: 18px; line-height: 28px;">Travel Grant</span><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 400; font-size: 18px; line-height: 28px;">. Your application has been received and is currently being evaluated by the selection committee.</span>
                  </div>
                 </div>
                </div>
               </td>
             ...
             <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
              <tr>
               <td valign="top" align="left">
                <div class="pc-font-alt" style="text-decoration: none;">
                 <div style="font-size:18px;line-height:28px;text-align:left;text-align-last:left;color:#4b4b4b;font-family:'Fira Sans', Arial, Helvetica, sans-serif;font-style:normal;letter-spacing:-0.2px;">
                  <div style="font-family:'Fira Sans', Arial, Helvetica, sans-serif;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-weight: 400; font-size: 18px; line-height: 28px;"> An official response will be sent to you by email once the selection process has been completed.</span>
                  </div>
                  <div>
                   <br>
                  </div>
